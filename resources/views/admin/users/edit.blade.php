...
@section('content')
    ...
    {!! Form::model($user, ['method' => 'PATCH', 'action' => ['AdminUsersController@update', $user->id] , 'id' => 'editUserForm', 'files'=> 'true']) !!}
...
{{--    </div>--}}
    ...
    <div class="form-group">
        {!! Form::submit('Update User', ['class' => 'btn btn-success col-xs-5']) !!}
    </div>
    ...
    {!! Form::open( ['method' => 'DELETE', 'action' => ['AdminUsersController@destroy', $user->id]]) !!}
        ...
        <div class="form-group ">
            {!! Form::submit('Delete User', ['class' => 'btn btn-danger col-xs-5 pull-right']) !!}
        </div>
