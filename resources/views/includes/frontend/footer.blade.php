        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">ArticlesDiary</h2>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <p><!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart color-danger" aria-hidden="true"></i> by <a href="https://umerportfolio.netlify.com" target="_blank">Umer Saeed</a>
...
<script src="{{ URL::asset('front-assets/js/jquery-migrate-3.0.1.min.js') }}"></script>
<script src="{{ URL::asset('front-assets/js/popper.min.js') }}"></script>
<script src="{{ URL::asset('front-assets/js/bootstrap.min.js') }}"></script>
<script src="{{ URL::asset('front-assets/js/jquery.easing.1.3.js') }}"></script>
<script src="{{ URL::asset('front-assets/js/jquery.waypoints.min.js') }}"></script>
<script src="{{ URL::asset('front-assets/js/jquery.stellar.min.js') }}"></script>
...
<script src="{{ URL::asset('front-assets/js/jquery.animateNumber.min.js') }}"></script>
<script src="{{ URL::asset('front-assets/js/scrollax.min.js') }}"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
<script src="{{ URL::asset('front-assets/js/google-map.js') }}"></script>
